package es.agonzalez.assistant.recipe.es.agonzalez.assistant.recipe.api.services.impl;
...
import es.agonzalez.assistant.recipe.es.agonzalez.assistant.recipe.api.dtos.IngredientResponse;
...
import es.agonzalez.assistant.recipe.es.agonzalez.assistant.recipe.api.repositories.IngredientRepository;
import es.agonzalez.assistant.recipe.es.agonzalez.assistant.recipe.api.repositories.RecipeRepository;
import es.agonzalez.assistant.recipe.es.agonzalez.assistant.recipe.api.services.RecipeService;
...
public class RecipeServiceImpl implements RecipeService {
    ...
    public RecipeResponse create(RecipeCreateRequest recipeCreateRequest) {
        Recipe recipe = Recipe.builder()
            .title(recipeCreateRequest.tittle())   
            .summary(recipeCreateRequest.summary())
            .steps(recipeCreateRequest.steps())
            .tags(Optional.ofNullable(recipeCreateRequest.tags()).orElseGet(Set::of).stream().map(String::trim).filter(s -> !s.isBlank()).collect(Collectors.toSet()))
            .build();
